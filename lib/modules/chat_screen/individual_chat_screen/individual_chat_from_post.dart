...
class IndividualChatFromPost extends StatefulWidget {
  IndividualChatFromPost(this.index, this.chatId, {Key? key}) : super(key: key);
  late int index;
  late String chatId;

  @override
  State<IndividualChatFromPost> createState() =>
      _IndividualChatFromPostState(this.chatId, this.index);
}
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
                    ...
                    const SizedBox(
                      ...
                      CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                            TimeLineUserCubit.get(context).getDataWorker!.data![index].photo!),
              ...
              title: Column(
                ...
                children: [
                    Text(
                      '${TimeLineUserCubit.get(context).getDataWorker!.data![index].name!}',
