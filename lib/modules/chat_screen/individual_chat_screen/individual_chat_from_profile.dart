...
class IndividualChatFromProfile extends StatefulWidget {
  IndividualChatFromProfile(this.index, this.chatId, {Key? key}) : super(key: key);
  late int index;
  late String chatId;

  @override
  State<IndividualChatFromProfile> createState() =>
      _IndividualChatFromProfileState(this.chatId, this.index);
}

class _IndividualChatFromProfileState extends State<IndividualChatFromProfile> {
  _IndividualChatFromProfileState(this.chatId, this.index);
                    ...
                    const SizedBox(
                      ...
                      CircleAvatar(
                        ...
                        backgroundImage: NetworkImage(
                            TimeLineCubit.get(context).getProfileSender!.data!.userData!.photo!),
                ...
                children: [
                  Expanded(
                    child: ConditionalBuilder(
                        condition: state is MessageSuccessState || Cubit.messageModel!.data!.length >= 0,
                        builder: (context) {
