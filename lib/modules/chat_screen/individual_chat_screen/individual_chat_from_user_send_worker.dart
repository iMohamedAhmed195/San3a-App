...
class IndividualChatFromUserSendWorker extends StatefulWidget {
  IndividualChatFromUserSendWorker(this.modelChat, {Key? key}) : super(key: key);
  ProfileModel? modelChat;

  @override
  State<IndividualChatFromUserSendWorker> createState() =>
      _IndividualChatFromUserSendWorkerState(this.modelChat);
}

class _IndividualChatFromUserSendWorkerState extends State<IndividualChatFromUserSendWorker> {
  _IndividualChatFromUserSendWorkerState(this.modelChat);
  ...
  void connectSocket() {
    ...
    socket!.onConnect((_) {
      ...
      socket!.emit("join", ChatCubit.get(context).messageModel!.chatID);
    });
  ...
  void sendMessage(String message) {
    ...
    socket!.emit("msg", {
      "content": message,
      "chat": ChatCubit.get(context).messageModel!.chatID,
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(
                      ...
                      CircleAvatar(
                        radius: 20,
                        backgroundImage: NetworkImage(modelChat!.data!.userData!.photo!),
              ...
              title: Column(
                ...
                children: [
                    Text(
                      '${modelChat!.data!.userData!.name!}',
                      style:  TextStyle(
                          fontSize: 18.5,
                          fontWeight: FontWeight.bold,
                          color: Colors.black),
                    ),
                   Text(San3aLayoutCubit.get(context).isArabic1? "اخر ظهور اليوم فى 12:30":'last seen today at 12:30',
              ...
              Row(
                ...
                children: [
                  attach(() {}, Icons.insert_drive_file, Colors.indigo,
                      San3aLayoutCubit.get(context).isArabic1?"المستندات ":'Documents'),
                  const SizedBox(
                    width: 40.0,
                  ),
                  attach(() {
